...
class GPGrid_intensity(object):
    ...
    def process_observations(self, obsx, obsy, obs_points): 
        ...
        if len(obs_points.shape)==1 or obs_points.shape[1]==1:
            ...
            presp = grid_p[self.obsx,self.obsy] + 1
            allresp = self.grid_all[self.obsx,self.obsy] + 2 # include some prior softening
        ...
        self.z = presp/allresp - 0.5 # self.grid_all[self.obsx,self.obsy]# 
